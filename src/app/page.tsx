...
const categories = [
  {
    title: "Custom Chains",
    description: "Statement chains designed to stand out.",
    icon: (
  ...
  },
  {
    ...
    description: "Pendants that carry your story.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: "Custom Rings",
    description: "Rings made to mark life's biggest moments.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        {/* Ring band */}
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center pt-20">
          ...
          >
            ...
            <Link
              href="/gallery"
              className="group inline-flex items-center gap-1.5 text-sm font-light tracking-wider text-charcoal/60 hover:text-gold transition-colors duration-300"
            >
              View Gallery
            ...
            <p className="text-xs font-light tracking-wide text-gray-warm/50">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {categories.map((cat, i) => (
              ...
              >
                <Link
                  href="/gallery"
                  className="block rounded-sm p-8 text-center border border-white/40 hover:border-gold/30 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)] transition-all duration-300 ease-out group bg-white/60 backdrop-blur-[10px]"
                >
